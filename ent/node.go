...
func (mc *MstCustomer) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(mc.CustDet); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(mc.CustAddr); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(mc.CustContact); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(mc.CustTel); err != nil {
		return nil, err
	}
	node.Fields[5] = &Field{
		Type:  "string",
